...
; 8. invalid label type (data label in relative mode) 
         bne  %int

; 9. invlid characters (%start) 
         bne  %%start

; 10. invalid operand (incomplete relative)
         jmp  % start         

; 11. invlid label (42) (or invalid characters (42))
         jsr  %42

; 12. invlid label (5xy) (or invalid characters (5xy))
         bne  %5xy

; 13. invalid operand (or invalid characters (%start))
end:     stop %start
